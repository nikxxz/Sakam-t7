...
const SearchModal1 = (props: any) => {
  ...
  if (songs == null) {
    return (
      <View style={{marginBottom: 30, marginHorizontal: 5 , alignItems:'center', flex:1,justifyContent:'center' , height:50}}>
      <Text bold color="white" mt={3}>Search for songs, artist...</Text>
      </View>
    );
  } else if(songs.length == 0) {
    return (
      <View style={{marginBottom: 30, marginHorizontal: 5 , alignItems:'center', flex:1,justifyContent:'center' , height:50}}>
      <Text bold color={theme.color.redDark} mt={3}>Song, artist not found...</Text>
      </View>
    );
  }
